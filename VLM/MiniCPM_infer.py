...
class MiniCPM:
    def __init__(self, version="o2.6"):
    ...
    def query_1(self, query_list, verbose=False):
        ...
        # image1 = add_label(image1, "Image 1")
        # image2 = add_label(image2, "Image 2")
        query_list = ["This is image_1:", image1, "This is image_2:", image2, query_prompt]
        res = self.model.chat(
            image=None,
    ...
    def query_2(self, query_list, summary_prompt, verbose=False):
        image1, image2, thought_prompt = query_list
        # image1 = add_label(image1, "Image 1")
        # image2 = add_label(image2, "Image 2")
        query_list = ["This is image_1:", image1, "This is image_2:", image2, thought_prompt]
        res = self.model.chat(
            image=None,
            msgs=[{'role': 'user', 'content': query_list}],
            tokenizer=self.tokenizer,
